...
import static com.umg.curso.clases.Ministerio.*;
...
public class ConsoleApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!salir) {
            ...
            System.out.println("4. Adicionar Deportista");
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 4:
                        ...
                        Deportista deportista = new Deportista(sn.next(),sn.nextInt());
                        /*deportista.setNombre(sn.next());
                        System.out.println("Edad del Deportista: ");
                        deportista.setEdad(sn.nextInt());*/
                        ministerio.listaDeportista(deportista);
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        for (Deportista d:ministerio.getDep()
                             ) {
